...
```
В консоле необходимо будет ввести размерность вашей матрицы смежности графа и после саму матрицу. В итоге получим расчеты и ответ в виде множества узлов B, входящие в него ребра которые являются самым узким местом в графе
```Docker
Введите количество строк: 6
Введите количество столбцов: 6
Введите элементы массива построчно:
0 7 4 2 0 0
3 0 8 4 1 0
6 8 0 0 2 0
5 9 0 0 8 4
