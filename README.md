...
| Удаление вершин | Удаление ребер |
|----------|----------|
...
| Удаляет указанный узел и все связанные с ним ребра | Удаляет конкретное ребро |
...
В программе расставляем вершины и связываем их ребрами с необходимым значением. И нажимаем кнопку «Найти минимальный разрез». Программа автоматически определяет ребра, относящиеся к минимальному разрезу, и выделяет их красным цветом 
