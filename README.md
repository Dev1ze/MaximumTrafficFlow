...
<div align="center">
    <img src="https://github.com/user-attachments/assets/73d06ccc-204d-45b8-a2f4-559522bfe18d"
    style="width: 100%"/>
</div>

## 🚀 Функциональность

🔹 Создание вершин — добавляйте вершины кликом мыши.

🔹 Редактирование ребер — добавляйте и удаляйте связи между вершинами.

🔹 Перемещение и удаление вершин — свободное управление элементами графа.
